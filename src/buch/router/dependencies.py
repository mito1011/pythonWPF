...
from src.buch.service.author_service import AuthorService, author_service
from src.buch.service.publisher_service import PublisherService, publisher_service
